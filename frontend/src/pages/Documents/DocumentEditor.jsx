    ...
    return (
        <div className='min-h-screen bg-[linear-gradient(180deg,#f8fafc_0%,#ffffff_35%,#fffdf7_100%)]'>
            ...
            <div className='max-w-6xl mx-auto px-4 md:px-8 py-8 md:py-10'>
                ...
                <div className='mt-6 rounded-[28px] border border-slate-200 bg-white shadow-sm overflow-hidden'>
                    <div className='border-b border-slate-100 px-6 md:px-8 py-5 bg-[linear-gradient(135deg,#fffef8_0%,#f8fbff_100%)]'>
                        <div className='flex flex-col md:flex-row md:items-end md:justify-between gap-4'>
                            <div>
                                <p className='text-[11px] font-bold uppercase tracking-[0.24em] text-slate-400'>Document Workspace</p>
                                <h1 className='text-2xl md:text-3xl font-bold text-slate-950 mt-2 flex items-center gap-2'>
                                    <MdDescription className='text-slate-400' />
                                    {isEditing ? 'Edit document' : 'New document'}
                                </h1>
                                <p className='text-sm text-slate-500 mt-2 max-w-2xl'>
                                    Use this space for long-form notes, structured thinking and deeper writing sessions.
                                </p>
                            </div>
