...
export const exportNoteToPDF = (title, htmlContent) => {
    ...
    element.innerHTML = `
        <div style="padding: 40px; font-family: 'Helvetica', 'Arial', sans-serif; color: #0f172a;">
            <style>
                h1 { font-size: 32px; font-weight: bold; margin-bottom: 24px; color: #1e293b; border-bottom: 2px solid #f1f5f9; padding-bottom: 10px; }
                h2 { font-size: 24px; font-weight: bold; margin-bottom: 16px; color: #1e293b; }
                p { font-size: 16px; line-height: 1.6; color: #334155; margin-bottom: 12px; }
                ul, ol { margin-bottom: 16px; padding-left: 24px; }
                li { margin-bottom: 8px; font-size: 16px; color: #334155; }
                blockquote { border-left: 4px solid #e2e8f0; padding-left: 16px; font-style: italic; color: #64748b; margin: 16px 0; }
                code { background-color: #f1f5f9; color: #db2777; padding: 2px 4px; border-radius: 4px; font-family: monospace; font-size: 14px; }
                pre { background-color: #0f172a; color: #f8fafc; padding: 16px; border-radius: 8px; font-family: monospace; font-size: 14px; margin: 16px 0; overflow: hidden; }
